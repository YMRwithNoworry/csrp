...
public final class ModMenus {
    ...
    public static final RegistryObject<MenuType<ParasiteLootMenu>> PARASITE_LOOT =
            MENUS.register("parasite_loot", () -> new MenuType<>(ParasiteLootMenu::new, FeatureFlags.DEFAULT_FLAGS));

    public static final RegistryObject<MenuType<RelayTerminalMenu>> RELAY_TERMINAL =
            MENUS.register("relay_terminal", () -> new MenuType<>(RelayTerminalMenu::new, FeatureFlags.DEFAULT_FLAGS));

    public static final RegistryObject<MenuType<ParasiticCystMenu>> PARASITIC_CYST =
            MENUS.register("parasitic_cyst", () -> new MenuType<>(ParasiticCystMenu::new, FeatureFlags.DEFAULT_FLAGS));

    public static final RegistryObject<MenuType<InfuserFurnaceMenu>> INFUSER_FURNACE =
