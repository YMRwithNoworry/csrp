...
public final class ModArmorMaterials {
    ...
    public static final RegistryObject<ArmorMaterial> LIVING = MATERIALS.register(
            "living", () -> material(Map.of(ArmorItem.Type.HELMET, 4, ArmorItem.Type.CHESTPLATE, 10,
                    ...
                    3.0F, 0.0F, "livings"));
    public static final RegistryObject<ArmorMaterial> SENTIENT = MATERIALS.register(
            "sentient", () -> material(Map.of(ArmorItem.Type.HELMET, 5, ArmorItem.Type.CHESTPLATE, 12,
                    ...
                    4.0F, 0.0F, "sentients"));
    public static final RegistryObject<ArmorMaterial> HIJACKED_IRON = MATERIALS.register(
    ...
    public static final RegistryObject<ArmorMaterial> VENKROL = MATERIALS.register(
    ...
    public static final RegistryObject<ArmorMaterial> MOBILITY = MATERIALS.register(
    ...
    private static ArmorMaterial material(Map<ArmorItem.Type, Integer> defense, int enchantmentValue,
        ...
        return new ArmorMaterial(defense, enchantmentValue, equipSound,
                ...
                List.of(new ArmorMaterial.Layer(new ResourceLocation(Csrp.MODID, layer))),
