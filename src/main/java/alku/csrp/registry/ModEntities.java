...
public final class ModEntities {
    ...
    public static final RegistryObject<EntityType<BiomassEntity>> BIOMASS =
            ENTITIES.register("biomass", () -> EntityType.Builder.of(BiomassEntity::new, MobCategory.MISC)
                    .sized(0.98F, 0.98F)
                    .clientTrackingRange(4)
                    .updateInterval(3)
                    .build(new ResourceLocation(Csrp.MODID, "biomass").toString()));
    ...
    public static final RegistryObject<EntityType<ShockwaveEntity>> SHOCKWAVE =
            ENTITIES.register("waveshock", () -> EntityType.Builder
                    ...
                    .build(new ResourceLocation(Csrp.MODID, "waveshock").toString()));
    public static final RegistryObject<EntityType<ShockwaveEntity>> SHOCKWAVE_LEGACY =
            ENTITIES.register("shockwave", () -> EntityType.Builder
                    .<ShockwaveEntity>of(ShockwaveEntity::new, MobCategory.MISC)
                    .sized(3.1F, 0.2F).clientTrackingRange(4).updateInterval(3)
                    .setShouldReceiveVelocityUpdates(true)
                    .build(new ResourceLocation(Csrp.MODID, "shockwave").toString()));
    public static final RegistryObject<EntityType<WardenShockwaveEntity>> WARDEN_SHOCKWAVE =
            ENTITIES.register("warden_waveshock", () -> EntityType.Builder
                    ...
                    .updateInterval(3)
                    .setShouldReceiveVelocityUpdates(true)
                    .build(new ResourceLocation(Csrp.MODID, "warden_waveshock").toString()));

    public static final RegistryObject<EntityType<BuglinEntity>> BUGLIN =
            ENTITIES.register("buglin", () -> EntityType.Builder.of(BuglinEntity::new, MobCategory.MONSTER)
                    .sized(0.5F, 0.3F)
                    .clientTrackingRange(8)
                    .build(new ResourceLocation(Csrp.MODID, "buglin").toString()));
    ...
    public static final RegistryObject<EntityType<LongarmsEntity>> PRI_LONGARMS =
            monster("pri_longarms", LongarmsEntity::new, 1.0F, 3.0F);
    public static final RegistryObject<EntityType<SummonerEntity>> PRI_SUMMONER =
            monster("pri_summoner", SummonerEntity::new, 1.3F, 2.3F);
    public static final RegistryObject<EntityType<VerminEntity>> PRI_VERMIN =
            monster("pri_vermin", VerminEntity::new, 1.1F, 1.4F, 0.7F);
    public static final RegistryObject<EntityType<VisceraEntity>> PRI_VISCERA =
            monster("pri_viscera", VisceraEntity::new, 1.211F, 2.351F, 1.5F);
    public static final RegistryObject<EntityType<PrimitiveVariantEntity>> PRI_ARACHNIDA =
            monster("pri_arachnida", (type, level) -> new PrimitiveVariantEntity(type, level,
                    PrimitiveVariantEntity.Kind.ARACHNIDA), 0.9F, 2.7F);
    public static final RegistryObject<EntityType<PrimitiveVariantEntity>> PRI_BOLSTER =
            monster("pri_bolster", (type, level) -> new PrimitiveVariantEntity(type, level,
                    PrimitiveVariantEntity.Kind.BOLSTER), 0.9F, 2.9F);
    public static final RegistryObject<EntityType<PrimitiveVariantEntity>> PRI_BURROWER =
    ...
    public static final RegistryObject<EntityType<AdaptedVariantEntity>> ADA_BOLSTER =
            monster("ada_bolster", (type, level) -> new AdaptedVariantEntity(type, level,
                    AdaptedVariantEntity.Kind.BOLSTER), 1.3F, 3.8F);
    public static final RegistryObject<EntityType<AdaptedVariantEntity>> ADA_BURROWER =
            monster("ada_burrower", (type, level) -> new AdaptedVariantEntity(type, level,
                    AdaptedVariantEntity.Kind.BURROWER), 1.321F, 1.2F, 1.0F);
    public static final RegistryObject<EntityType<AdaptedVariantEntity>> ADA_DEVOURER =
            monster("ada_devourer", (type, level) -> new AdaptedVariantEntity(type, level,
                    AdaptedVariantEntity.Kind.DEVOURER), 0.901F, 3.5F);
    public static final RegistryObject<EntityType<AdaptedVariantEntity>> ADA_LONGARMS =
            monster("ada_longarms", (type, level) -> new AdaptedVariantEntity(type, level,
                    AdaptedVariantEntity.Kind.LONGARMS), 0.901F, 3.5F);
    public static final RegistryObject<EntityType<AdaptedVariantEntity>> ADA_MANDUCATER =
            monster("ada_manducater", (type, level) -> new AdaptedVariantEntity(type, level,
                    AdaptedVariantEntity.Kind.MANDUCATER), 1.4F, 2.7F);
    public static final RegistryObject<EntityType<AdaptedVariantEntity>> ADA_REEKER =
            monster("ada_reeker", (type, level) -> new AdaptedVariantEntity(type, level,
                    AdaptedVariantEntity.Kind.REEKER), 1.3F, 3.3F);
    public static final RegistryObject<EntityType<AdaptedVariantEntity>> ADA_SUMMONER =
            monster("ada_summoner", (type, level) -> new AdaptedVariantEntity(type, level,
                    AdaptedVariantEntity.Kind.SUMMONER), 0.901F, 3.5F);
    public static final RegistryObject<EntityType<AdaptedVariantEntity>> ADA_TOZOON =
            monster("ada_tozoon", (type, level) -> new AdaptedVariantEntity(type, level,
                    AdaptedVariantEntity.Kind.TOZOON), 1.321F, 1.2F, 1.0F);
    public static final RegistryObject<EntityType<AdaptedVariantEntity>> ADA_VERMIN =
            monster("ada_vermin", (type, level) -> new AdaptedVariantEntity(type, level,
                    AdaptedVariantEntity.Kind.VERMIN), 1.1F, 1.4F, 0.7F);
    public static final RegistryObject<EntityType<AdaptedVariantEntity>> ADA_VISCERA =
            monster("ada_viscera", (type, level) -> new AdaptedVariantEntity(type, level,
                    AdaptedVariantEntity.Kind.VISCERA), 1.511F, 3.655F);
    public static final RegistryObject<EntityType<AdaptedVariantEntity>> ADA_YELLOWEYE =
            monster("ada_yelloweye", (type, level) -> new AdaptedVariantEntity(type, level,
                    AdaptedVariantEntity.Kind.YELLOWEYE), 1.3F, 2.9F);
    public static final RegistryObject<EntityType<GnatEntity>> GNAT =
            monster("gnat", GnatEntity::new, 0.85F, 1.0F);
    public static final RegistryObject<EntityType<CarrierHeavyEntity>> CARRIER_HEAVY =
            monster("carrier_heavy", CarrierHeavyEntity::new, 1.3F, 3.1F);
    public static final RegistryObject<EntityType<CarrierLightEntity>> CARRIER_LIGHT =
            monster("carrier_light", CarrierLightEntity::new, 0.85F, 2.3F);
    public static final RegistryObject<EntityType<CarrierFlyingEntity>> CARRIER_FLYING =
            monster("carrier_flying", CarrierFlyingEntity::new, 1.4F, 2.4F, 2.4F);
    public static final RegistryObject<EntityType<CarrierWormEntity>> CARRIER_WORM =
            monster("carrier_worm", CarrierWormEntity::new, 1.321F, 1.2F, 1.0F);
    public static final RegistryObject<EntityType<CruxEntity>> CRUX =
            monster("crux", CruxEntity::new, 1.13333F, 3.3F);
    public static final RegistryObject<EntityType<IncompleteCruxEntity>> CRUX_INCOMPLETE =
            monster("crux_incomplete", IncompleteCruxEntity::new, 1.31F, 1.1F);
    public static final RegistryObject<EntityType<AirscrewEntity>> AIRSCREW =
            monster("airscrew", AirscrewEntity::new, 2.1F, 7.1F);
    public static final RegistryObject<EntityType<HeedEntity>> HEED =
            monster("heed", HeedEntity::new, 0.9F, 1.9F);
    public static final RegistryObject<EntityType<DredgeEntity>> DREDGE =
            monster("dredge", DredgeEntity::new, 0.8F, 3.4F, 1.73F);
    public static final RegistryObject<EntityType<ThrallEntity>> THRALL =
            monster("thrall", ThrallEntity::new, 0.8F, 3.05F);
    public static final RegistryObject<EntityType<LiceEntity>> LICE =
            monster("lice", LiceEntity::new, 0.85F, 1.0F);
    public static final RegistryObject<EntityType<ManglerEntity>> MANGLER =
            monster("mangler", ManglerEntity::new, 1.0F, 1.0F, 0.9F);
    public static final RegistryObject<EntityType<HostEntity>> HOST =
            monster("host", HostEntity::new, 0.9F, 3.5F);
    public static final RegistryObject<EntityType<HostIIEntity>> HOSTII =
            monster("hostii", HostIIEntity::new, 1.5F, 7.5F);
    public static final RegistryObject<EntityType<IncompleteFormSmallEntity>> INCOMPLETEFORM_SMALL =
            monster("incompleteform_small", IncompleteFormSmallEntity::new, 0.6F, 0.85F);
    public static final RegistryObject<EntityType<IncompleteFormMediumEntity>> INCOMPLETEFORM_MEDIUM =
            monster("incompleteform_medium", IncompleteFormMediumEntity::new, 0.6F, 1.95F);
    public static final RegistryObject<EntityType<DraconiteEntity>> DRACONITE =
    ...
    public static final RegistryObject<EntityType<AssimilatedDragonEntity>> SIM_DRAGONE =
            monster("sim_dragone", AssimilatedDragonEntity::new, 1.9F, 3.8F);
    public static final RegistryObject<EntityType<DragonEggAssimilationEntity>> DRAGON_EGG_ASSIMILATION =
    ...
    public static final RegistryObject<EntityType<MarauderTendrilEntity>> MARAUDER_TENDRIL =
            monster("marauder_tendril", MarauderTendrilEntity::new, 0.6F, 2.0F);
    public static final RegistryObject<EntityType<DeterrentParasiteEntity>> DISPATCHERTEN =
    ...
    public static final RegistryObject<EntityType<PreeminentParasiteEntity>> HAUNTER =
            monster("haunter", (type, level) -> new PreeminentParasiteEntity(type, level,
                    PreeminentParasiteEntity.Kind.HAUNTER), 2.0F, 3.6F);
    public static final RegistryObject<EntityType<PreeminentParasiteEntity>> BOMBER_HEAVY =
    ...
    public static final RegistryObject<EntityType<PreeminentParasiteEntity>> WRAITH =
            monster("wraith", (type, level) -> new PreeminentParasiteEntity(type, level,
                    PreeminentParasiteEntity.Kind.WRAITH), 4.0F, 4.0F);
    public static final RegistryObject<EntityType<FlamEntity>> SUCCOR =
            monster("succor", FlamEntity::new, 1.2F, 1.2F);
    public static final RegistryObject<EntityType<AncientParasiteEntity>> ANC_DREADNAUT =
            monster("anc_dreadnaut", (type, level) -> new AncientParasiteEntity(type, level,
                    AncientParasiteEntity.Kind.DREADNAUT), 4.0F, 4.0F);
    public static final RegistryObject<EntityType<AncientParasiteEntity>> ANC_OVERLORD =
    ...
    public static final RegistryObject<EntityType<PullingBallEntity>> PULLING_BALL =
            ENTITIES.register("pullingball", () -> EntityType.Builder
                    ...
                    .build(new ResourceLocation(Csrp.MODID, "pullingball").toString()));
    public static final RegistryObject<EntityType<PullingBallEntity>> PULLING_BALL_LEGACY =
            ENTITIES.register("pulling_ball", () -> EntityType.Builder
                    .<PullingBallEntity>of(PullingBallEntity::new, MobCategory.MISC)
                    .sized(0.3F, 0.3F).clientTrackingRange(4).updateInterval(3)
                    .build(new ResourceLocation(Csrp.MODID, "pulling_ball").toString()));
    public static final RegistryObject<EntityType<CruxThrownBlockDamageEntity>> CRUX_BLOCK_DAMAGE =
            ENTITIES.register("crux_block_damage", () -> EntityType.Builder
                    ...
                    .build(new ResourceLocation(Csrp.MODID, "crux_block_damage").toString()));
    public static final RegistryObject<EntityType<HaunterDamageEntity>> HAUNTER_DAMAGE =
            ENTITIES.register("haunter_damage", () -> EntityType.Builder
                    ...
                    .build(new ResourceLocation(Csrp.MODID, "haunter_damage").toString()));
    public static final RegistryObject<EntityType<ScaryOrbEntity>> SCARY_ORB =
            ENTITIES.register("orbscary", () -> EntityType.Builder.<ScaryOrbEntity>of(ScaryOrbEntity::new, MobCategory.MISC)
                    ...
                    .build(new ResourceLocation(Csrp.MODID, "orbscary").toString()));
    public static final RegistryObject<EntityType<ScaryOrbEntity>> SCARY_ORB_LEGACY =
            ENTITIES.register("scary_orb", () -> EntityType.Builder.<ScaryOrbEntity>of(ScaryOrbEntity::new, MobCategory.MISC)
                    .sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(3)
                    .build(new ResourceLocation(Csrp.MODID, "scary_orb").toString()));
    public static final RegistryObject<EntityType<VoidOrbEntity>> VOID_ORB =
            ENTITIES.register("orbvoid", () -> EntityType.Builder.<VoidOrbEntity>of(VoidOrbEntity::new, MobCategory.MISC)
                    ...
                    .build(new ResourceLocation(Csrp.MODID, "orbvoid").toString()));
    public static final RegistryObject<EntityType<ParasiticScentEntity>> SCENT =
            ENTITIES.register("scent", () -> EntityType.Builder
                    ...
                    .build(new ResourceLocation(Csrp.MODID, "scent").toString()));
    public static final RegistryObject<EntityType<ParasiteProjectileEntity>> PARASITE_PROJECTILE =
            ENTITIES.register("parasite_projectile", () -> EntityType.Builder
                    ...
                    .build(new ResourceLocation(Csrp.MODID, "parasite_projectile").toString()));
    public static final RegistryObject<EntityType<ParasiteProjectileEntity>> WEB_BALL =
            projectile("webball", ParasiteProjectileEntity.Mode.WEB, 0.3F, 0.3F, 4, 3);
    public static final RegistryObject<EntityType<ParasiteProjectileEntity>> SPINE_BALL =
            projectile("spineball", ParasiteProjectileEntity.Mode.SPINE, 0.3F, 0.3F, 4, 3);
    public static final RegistryObject<EntityType<ParasiteProjectileEntity>> NADE_BALL =
            projectile("nadeball", ParasiteProjectileEntity.Mode.ELVIA_NADE, 0.3F, 0.3F, 4, 3);
    public static final RegistryObject<EntityType<ParasiteProjectileEntity>> BALL_TALL =
            projectile("balltall", ParasiteProjectileEntity.Mode.ELVIA_BALL, 0.3F, 0.3F, 4, 3);
    public static final RegistryObject<EntityType<ParasiteProjectileEntity>> BALL_MALL =
    ...
    public static final RegistryObject<EntityType<ParasiteProjectileEntity>> ANCIENT_BALL =
            projectile("ancientball", ParasiteProjectileEntity.Mode.ANCIENT_BALL, 0.3F, 0.3F, 4, 3);
    public static final RegistryObject<EntityType<ParasiteProjectileEntity>> MISSILE =
            projectile("missile", ParasiteProjectileEntity.Mode.DRAGON_MISSILE, 0.3F, 0.3F, 4, 3);
    public static final RegistryObject<EntityType<ParasiteProjectileEntity>> SALIVA_EFFECT =
            projectile("salivaeff", ParasiteProjectileEntity.Mode.SALIVA_EFFECT, 0.3F, 0.3F, 4, 3);
    public static final RegistryObject<EntityType<ParasiteProjectileEntity>> BIOMASS_BALL =
            projectile("biomassball", ParasiteProjectileEntity.Mode.BIOMASS_BALL, 0.3F, 0.3F, 4, 3);
    public static final RegistryObject<EntityType<AntiInfestedBlockEntity>> ANTI_INFESTED_BLOCK =
            ENTITIES.register("antiinfestedblock", () -> EntityType.Builder
                    ...
                    .sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(3)
                    .build(new ResourceLocation(Csrp.MODID, "antiinfestedblock").toString()));
    public static final RegistryObject<EntityType<OrbBoomEntity>> ORB_BOOM =
            ENTITIES.register("orbboom", () -> EntityType.Builder
                    .<OrbBoomEntity>of(OrbBoomEntity::new, MobCategory.MISC)
                    .sized(0.5F, 0.5F).clientTrackingRange(16).updateInterval(1)
                    .build(new ResourceLocation(Csrp.MODID, "orbboom").toString()));
    public static final RegistryObject<EntityType<SourceEntity>> SOURCE =
            ENTITIES.register("source", () -> EntityType.Builder
                    .<SourceEntity>of(SourceEntity::new, MobCategory.MISC)
                    .sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(3)
                    .build(new ResourceLocation(Csrp.MODID, "source").toString()));
    public static final RegistryObject<EntityType<RemainEntity>> REMAIN =
            ENTITIES.register("remain", () -> EntityType.Builder
                    .<RemainEntity>of(RemainEntity::new, MobCategory.MISC)
                    .sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(3)
                    .build(new ResourceLocation(Csrp.MODID, "remain").toString()));
    public static final RegistryObject<EntityType<BombEntity>> BOMB =
            ENTITIES.register("bomb", () -> EntityType.Builder
                    ...
                    .setShouldReceiveVelocityUpdates(true)
                    .build(new ResourceLocation(Csrp.MODID, "bomb").toString()));
    public static final RegistryObject<EntityType<ToxicCloudEntity>> CLOUD_TOXIC =
            ENTITIES.register("cloudtoxic", () -> EntityType.Builder
                    ...
                    .build(new ResourceLocation(Csrp.MODID, "cloudtoxic").toString()));
    public static final RegistryObject<EntityType<GoreEntity>> GORE =
            ENTITIES.register("gore", () -> EntityType.Builder
                    ...
                    .build(new ResourceLocation(Csrp.MODID, "gore").toString()));
    public static final RegistryObject<EntityType<TendrilEntity>> TENDRIL =
            ENTITIES.register("tendril", () -> EntityType.Builder
                    ...
                    .build(new ResourceLocation(Csrp.MODID, "tendril").toString()));
    public static final RegistryObject<EntityType<WaveEntity>> WAVE =
            ENTITIES.register("wave", () -> EntityType.Builder
                    ...
                    .build(new ResourceLocation(Csrp.MODID, "wave").toString()));
    public static final RegistryObject<EntityType<NadeEntity>> NADE =
            ENTITIES.register("nade", () -> EntityType.Builder
                    .<NadeEntity>of(NadeEntity::new, MobCategory.MISC)
                    .sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(3)
                    .build(new ResourceLocation(Csrp.MODID, "nade").toString()));
    public static final RegistryObject<EntityType<HaunterHomingProjectileEntity>> HAUNTER_HOMING =
            ENTITIES.register("homming", () -> EntityType.Builder
                    ...
                    .setShouldReceiveVelocityUpdates(true)
                    .build(new ResourceLocation(Csrp.MODID, "homming").toString()));
    public static final RegistryObject<EntityType<HaunterHomingProjectileEntity>> HAUNTER_HOMING_LEGACY =
            ENTITIES.register("haunter_homing", () -> EntityType.Builder
                    .<HaunterHomingProjectileEntity>of(HaunterHomingProjectileEntity::new, MobCategory.MISC)
                    .sized(0.3125F, 0.3125F).clientTrackingRange(4).updateInterval(3)
                    .setShouldReceiveVelocityUpdates(true)
                    .build(new ResourceLocation(Csrp.MODID, "haunter_homing").toString()));
    ...
    private static RegistryObject<EntityType<ParasiteProjectileEntity>> projectile(
