...
public final class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<ParasiteLootBlockEntity>> PARASITE_LOOT =
    ...
    public static final RegistryObject<BlockEntityType<RelayTerminalBlockEntity>> RELAY_TERMINAL =
    ...
    public static final RegistryObject<BlockEntityType<DispatcherNidusBlockEntity>> DISPATCHER_NIDUS =
    ...
    public static final RegistryObject<BlockEntityType<ParasiticCystBlockEntity>> PARASITIC_CYST =
    ...
    public static final RegistryObject<BlockEntityType<InfuserFurnaceBlockEntity>> INFUSER_FURNACE =
    ...
    public static final RegistryObject<BlockEntityType<BiomePurifierBlockEntity>> BIOME_PURIFIER =
    ...
    public static final RegistryObject<BlockEntityType<FogNullifierBlockEntity>> FOG_NULLIFIER =
