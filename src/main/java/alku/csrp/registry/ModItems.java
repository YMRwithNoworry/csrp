...
public final class ModItems {
    ...
    public static final DeferredItem<BlockItem> DISEASED_SPONGE = ITEMS.registerSimpleBlockItem(
...
public static final DeferredItem<BlockItem> PARASITERUBBLE_BONE = ITEMS.registerSimpleBlockItem("parasiterubble_bone", ModBlocks.PARASITERUBBLE_BONE);
    ...
    public static final DeferredItem<BlockItem> PARASITESTAIN_SPORE = ITEMS.registerSimpleBlockItem("parasitestain_spore", ModBlocks.PARASITESTAIN_SPORE);
    public static final DeferredItem<BlockItem> PARASITESTAIN_RED = ITEMS.registerSimpleBlockItem("parasitestain_red", ModBlocks.PARASITESTAIN_RED);
    public static final DeferredItem<BlockItem> PARASITESTAIN_SACKFLESH = ITEMS.registerSimpleBlockItem("parasitestain_sackflesh", ModBlocks.PARASITESTAIN_SACKFLESH);
