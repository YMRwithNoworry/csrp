...
public final class QuenchItem extends Item {
    ...
    public InteractionResult use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide()) {
            Snowball projectile = new Snowball(level, player, new ItemStack(this));
            ...
            level.playSound(null, player.blockPosition(), SoundEvents.SNOWBALL_THROW,
                    SoundSource.PLAYERS, 0.5F, 0.35F + level.getRandom().nextFloat() * 0.15F);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display,
        ...
        builder.accept(Component.translatable("tooltip.csrp.quench")
