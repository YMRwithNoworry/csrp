...
public final class PrimitiveParasiteModel<T extends Mob & CitadelAnimatedEntity>
    ...
    private static final Identifier CARRIER_HEAVY_VARIANT_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/ratholone.png");
    private static final Identifier CARRIER_FLYING_VARIANT_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/butholone.png");
    private static final Identifier CARRIER_VARIANT_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/vestare.png");
    private static final Identifier HAUNTER_VARIANT_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/pheonsp1.png");
    private static final Identifier BOLSTER_BERSERKER_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/ada_bolster_berserker.png");
    private static final Identifier BOLSTER_VIRULENT_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/ada_bolster_virulent.png");
    private static final Identifier BOLSTER_BREACHER_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/ada_bolster_breacher.png");
    private static final Identifier BOLSTER_VIRULENT_PRIMITIVE_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/banov.png");
    private static final Identifier BOLSTER_HEAVY_PRIMITIVE_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/banoh.png");
    private static final Identifier MANDUCATER_HEAVY_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/hullh.png");
    private static final Identifier ARACHNIDA_VIRULENT_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/ada_arachnida_virulent.png");
    private static final Identifier ARACHNIDA_BLEEDING_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/ada_arachnida_bleeding.png");
    private static final Identifier ARACHNIDA_HEAVY_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/ada_arachnida_heavy.png");
    private static final Identifier SHRIMP_FED_ENDERMAN_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/sim_enderman_ariral.png");
    private static final Identifier VARIANT_ENDERMAN_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/sim_enderman_variant.png");
    private static final Identifier REEKER_FRAGILE_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/noglasp1.png");
    private static final Identifier REEKER_VIRULENT_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/noglav.png");
    private static final Identifier REEKER_BERSERKER_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/noglab.png");
    private static final Identifier REEKER_HEAVY_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/noglah.png");
    private static final Identifier REEKER_RICARDO_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/ricardo.png");
    private static final Identifier REEKER_RICARDO_BALD_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/ricardo_bald.png");
    private static final Identifier DEVOURER_HEAVY_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/pri_devourer_heavy.png");
    private static final Identifier YELLOWEYE_HEAVY_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/pri_yelloweye_heavy.png");
    private static final Identifier MANGLER_VIRAL_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/nuuhv.png");
    private static final Identifier MANGLER_BLEEDING_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/nuuhb.png");
    private static final Identifier MANGLER_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/nuuh.png");
    private static final Identifier GRUNT_VIRULENT_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/monster/flogv.png");
    private static final Identifier GRUNT_BLEEDING_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/monster/flogb.png");
    private static final Identifier GRUNT_HEAVY_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/monster/flogh.png");
    private static final Identifier OMBOO_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/monster/omboo.png");
    private static final Identifier OMBOO_HEAVY_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/monster/ombooh.png");
    private static final Identifier MONARCH_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/orch.png");
    private static final Identifier MONARCH_SKIN_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/orchsp1.png");
    private static final Identifier MONARCH_HEAVY_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/orchh.png");
    private static final Identifier OVERSEER_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/monster/alafha.png");
    private static final Identifier OVERSEER_HEAVY_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/monster/alafhah.png");
    private static final Identifier VIGILANTE_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/monster/anged.png");
    private static final Identifier VIGILANTE_HEAVY_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/monster/angedh.png");
    private static final Identifier WARDEN_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/monster/ganro.png");
    private static final Identifier WARDEN_HEAVY_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/monster/ganroh.png");
    private static final Identifier MARAUDERIZED_COW_RAGE_TEXTURE =
            Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/mar_cow_desert.png");
    ...
    public PrimitiveParasiteModel(String id) {
        super(id);
        texture = Identifier.fromNamespaceAndPath(Csrp.MODID, "textures/entity/" + id + ".png");
    }

    @Override
    public Identifier texture(T animatable) {
