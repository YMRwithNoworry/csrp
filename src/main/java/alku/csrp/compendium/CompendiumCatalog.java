...
public final class CompendiumCatalog {
    public static final List<String> BLOCKS = List.of(
            ...
            "infested_furnace", "biomass_block", "residue_block", "sick_alveoli", "alveoli",
            "hair_follicle_block", "parasite_barrier", "assimilated_pumpkin", "esca_bulb",
            "node_redstone_lamp", "parasiteloot_common", "infestation_purifier", "parasitemouth",
            "relay_base", "relay_middle", "relay_roof", "biomepurifier", "infested_remain", "diseased_sponge");
