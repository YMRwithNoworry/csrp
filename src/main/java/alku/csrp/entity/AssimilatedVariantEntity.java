 ...
 */
public final class AssimilatedVariantEntity extends Monster implements CitadelAnimatedEntity, Parasite, MeltableAssimilated, SelfeFuseOwner {
    ...
    protected void registerGoals() {
        ...
        if (kind == Kind.HORSE) {
            // Legacy EntityInfHorse:73 EntityAIAttackSwell(this, 5.0) plus its half-health setSelfeState gate.
            goalSelector.addGoal(2, new AttackSwellGoal(this, 5.0D, true));
        }
