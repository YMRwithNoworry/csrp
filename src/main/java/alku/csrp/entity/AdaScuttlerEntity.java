...
public class AdaScuttlerEntity extends BurrowingVariantEntity implements PullingBallOwner {
    ...
    private final CitadelRawAnimation FAST_MOVE = ParasiteAnimations.loop(this, "walk.get_parasite_status_2");
    private final CitadelRawAnimation PULLING_PREP = ParasiteAnimations.loop(this, "idle.get_parasite_status_3");
    ...
    private CitadelPlayState movementAnimation(CitadelAnimationState<AdaScuttlerEntity> state) {
