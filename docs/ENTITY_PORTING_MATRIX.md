...
Progress: **48 / 119** indexed creatures ported.
...
| Marauderized | `mar_bear`, `mar_cow`, `mar_enderman`, `mar_human`, `mar_sheep`, `mar_villager`, `marauder` | 6 ported; `marauder` pending |
