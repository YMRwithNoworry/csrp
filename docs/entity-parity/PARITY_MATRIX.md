...
> 生成时间：2026-09-25T01:46:19.308Z；方法见 `docs/entity-parity/AUDIT_PROTOCOL.md`，逐生物明细见 `docs/entity-parity/raw/<id>.json`。
> 判定：✅ 全部条款满足；🟠 有部分实现但无缺失；❌ 存在缺失；· 未审计。

- 注册生物总数：**127**；已审计：**13**；未审计：**114**
- 条款总计：满足 610 / 部分 388 / 缺失 324（不计入 57 条不适用）
- **加权完成度：60.8%**（partial 计 0.5）
...
| 伤害/效果 `damage_and_effects` | 92 | 16 | 30 | 72.5% |
...
| `hi_skeleton` | EntityHiSkeleton | HiSkeletonEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | 55.4% |
| `pri_longarms` | EntityShyco | LongarmsEntity | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 59.5% |
