...
> 生成时间：2026-09-25T01:07:29.533Z；方法见 `docs/entity-parity/AUDIT_PROTOCOL.md`，逐生物明细见 `docs/entity-parity/raw/<id>.json`。
> 判定：✅ 全部条款满足；🟠 有部分实现但无缺失；❌ 存在缺失；· 未审计。

- 注册生物总数：**127**；已审计：**13**；未审计：**114**
- 条款总计：满足 523 / 部分 397 / 缺失 402（不计入 57 条不适用）
- **加权完成度：54.6%**（partial 计 0.5）
...
| 属性 `attributes` | 64 | 30 | 31 | 63.2% |
| AI `ai` | 70 | 76 | 43 | 57.1% |
| 行为 `behaviors` | 99 | 84 | 117 | 47% |
| 伤害/效果 `damage_and_effects` | 59 | 17 | 62 | 48.9% |
...
| ancient | 0/4 | 0 | 0 | 0 | 0% |
| hijacked_and_feral | 2/12 | 73 | 60 | 93 | 45.6% |
| nexus_and_aberrant | 1/15 | 37 | 38 | 38 | 49.6% |
| marauderized | 1/7 | 41 | 27 | 36 | 52.4% |
| early_lifecycle | 1/10 | 33 | 26 | 26 | 54.1% |
| current | 2/13 | 78 | 44 | 53 | 57.1% |
| assimilated | 6/23 | 261 | 202 | 156 | 58.5% |
...
| `fer_villager` | EntityFerVillager | FeralParasiteEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 43.7% |
| `hi_skeleton` | EntityHiSkeleton | HiSkeletonEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | 48.4% |
| `beckon_siii` | EntityVenkrolSIII | NexusParasiteEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | 49.6% |
| `mar_cow` | EntitySpeCow | MarauderizedCowEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 52.4% |
| `pri_longarms` | EntityShyco | LongarmsEntity | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 53.8% |
| `host` | EntityHost | HostEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | 🟠 | 54.1% |
| `sim_human` | EntityInfHuman | SimHumanEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | 56.4% |
| `sim_squid` | EntityInfSquid | AssimilatedParasiteEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | 🟠 | 57.5% |
| `sim_wolf` | EntityInfWolf | AssimilatedParasiteEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | 58.4% |
| `sim_cow` | EntityInfCow | AssimilatedParasiteEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | 58.5% |
| `sim_bigspider` | EntityDorpa | AssimilatedVariantEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | 🟠 | 59.7% |
| `sim_sheep` | EntityInfSheep | AssimilatedParasiteEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | 60.5% |
| `buglin` | EntityLodo | BuglinEntity | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | 62.1% |
