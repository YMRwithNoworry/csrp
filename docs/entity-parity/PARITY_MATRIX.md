...
> 生成时间：2026-09-25T01:21:15.418Z；方法见 `docs/entity-parity/AUDIT_PROTOCOL.md`，逐生物明细见 `docs/entity-parity/raw/<id>.json`。
> 判定：✅ 全部条款满足；🟠 有部分实现但无缺失；❌ 存在缺失；· 未审计。

- 注册生物总数：**127**；已审计：**13**；未审计：**114**
- 条款总计：满足 568 / 部分 394 / 缺失 360（不计入 57 条不适用）
- **加权完成度：57.9%**（partial 计 0.5）
...
| AI `ai` | 70 | 76 | 43 | 57.1% |
| 行为 `behaviors` | 112 | 83 | 105 | 51.2% |
| 伤害/效果 `damage_and_effects` | 89 | 16 | 33 | 70.3% |
...
| ancient | 0/4 | 0 | 0 | 0 | 0% |
| hijacked_and_feral | 2/12 | 87 | 59 | 80 | 51.5% |
| nexus_and_aberrant | 1/15 | 40 | 38 | 35 | 52.2% |
| marauderized | 1/7 | 48 | 26 | 30 | 58.7% |
| assimilated | 6/23 | 267 | 202 | 150 | 59.5% |
| current | 2/13 | 86 | 44 | 45 | 61.7% |
| early_lifecycle | 1/10 | 40 | 25 | 20 | 61.8% |
...
| `fer_villager` | EntityFerVillager | FeralParasiteEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 49.6% |
| `beckon_siii` | EntityVenkrolSIII | NexusParasiteEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | 52.2% |
| `hi_skeleton` | EntityHiSkeleton | HiSkeletonEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | 54.3% |
| `sim_human` | EntityInfHuman | SimHumanEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | 57.3% |
| `sim_squid` | EntityInfSquid | AssimilatedParasiteEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | 🟠 | 58.6% |
| `pri_longarms` | EntityShyco | LongarmsEntity | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 58.6% |
| `mar_cow` | EntitySpeCow | MarauderizedCowEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 58.7% |
| `sim_wolf` | EntityInfWolf | AssimilatedParasiteEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | 59.3% |
| `sim_cow` | EntityInfCow | AssimilatedParasiteEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | 59.4% |
| `sim_bigspider` | EntityDorpa | AssimilatedVariantEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | 🟠 | 60.7% |
| `sim_sheep` | EntityInfSheep | AssimilatedParasiteEntity | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | 61.4% |
| `host` | EntityHost | HostEntity | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 🟠 | 🟠 | 61.8% |
| `buglin` | EntityLodo | BuglinEntity | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | 🟠 | ❌ | ❌ | ❌ | ❌ | 66.4% |
