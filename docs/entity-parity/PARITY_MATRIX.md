...
| `sim_humanhead` | EntityInfHumanHead | AssimilatedHeadEntity | ❌ | 🟠 | 🟠 | ❌ | ❌ | ❌ | 🟠 | ❌ | 🟠 | ❌ | ✅ | 73.2% |
| `sim_villagerhead` | EntityInfVillagerHead | AssimilatedHeadEntity | ❌ | ❌ | 🟠 | ❌ | ✅ | ❌ | ✅ | ❌ | 🟠 | ❌ | ✅ | 73.8% |
...
| `sim_dragonehead` | EntityInfDragonEHead | AssimilatedDragonHeadEntity | ❌ | ❌ | 🟠 | 🟠 | ✅ | ❌ | 🟠 | ✅ | ✅ | ❌ | ✅ | 75.5% |
...
| `sim_cowhead` | EntityInfCowHead | AssimilatedHeadEntity | ❌ | ❌ | 🟠 | ❌ | ✅ | ❌ | ✅ | ✅ | 🟠 | ❌ | ✅ | 77.5% |
| `sim_pighead` | EntityInfPigHead | AssimilatedHeadEntity | ❌ | ❌ | 🟠 | ❌ | ✅ | ❌ | ✅ | ✅ | 🟠 | ❌ | ✅ | 77.5% |
