...
- 覆盖：**30/127** 只生物已出条款级审计
- 条款：满足 **1472**、部分 **647**、缺失 **395**（另有 130 条判定为不适用）
- **加权完成度：71.4%**
...
| `sim_dragonehead` | EntityInfDragonEHead | AssimilatedDragonHeadEntity | 75.5% | 35/13/7 |
